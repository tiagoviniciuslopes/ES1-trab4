...
<div id="wrapper">
	...
	<section>
		<div id="extra" class="container">
			<p align = "justify">
			Nome : ${fornecedor.getNomeCompleto()}<br />
			CNPJ : ${fornecedor.getCnpj().getNumeroDoc()}<br />
			Pais : ${fornecedor.getEnderecoEspecifico().getEndereco().getCidade().getUf().getPais().getNome()}<br />
			</p>
		</div>
	</section>
</div>
