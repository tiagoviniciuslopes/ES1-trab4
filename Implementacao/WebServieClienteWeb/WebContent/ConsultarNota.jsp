...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			...
			<header>
				<h1>Consultar Nota <span> Clique para expandir a busca</span></h1>
			</header>
			<div class="main clearfix">
				<!-- Optional columns for small components -->
				<div class="column">
					<p>Trabalho 4 de Engenharia de Software - Digite o código da nota para buscar</p>
					<p><a href="index.jsp">Página inicial</a></p>
				</div>
				<div class="column">
					<div id="sb-search" class="sb-search">
						<form action="consultas/ConsultarNota">
