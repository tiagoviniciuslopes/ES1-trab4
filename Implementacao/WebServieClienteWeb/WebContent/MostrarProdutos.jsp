...
<div id="wrapper">
	...
	<section>
		<div id="extra" class="container">
			<p align = "justify">
			Código de barras: ${produto.getCodBarras()}<br />
			Nome do produto : ${produto.getNomeProduto()}<br />
			Quantidade em estoque : ${produto.getQuantidadeEstoque()}<br />	
			Nome do fornecedor: ${produto.getFornecedor().getNomeCompleto()}<br />
			CNPJ do fornecedor : ${produto.getFornecedor().getCnpj().getNumeroDoc()}<br />
			Preço do custo atual : ${produto.getPrecoCustoAtual()}<br />
			Preço de venda atual : ${produto.getPrecoVendaAtual()}<br />
			</p>
		</div>
	</section>
</div>
