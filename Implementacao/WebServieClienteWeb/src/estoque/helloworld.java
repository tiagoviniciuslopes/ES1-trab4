...
public class helloworld {
	...
	public void setResponse(String mensagem){
		...
		intencao = response.getOutput().getIntents().get(0).intent();
		valor = Integer.parseInt(response.getOutput().getEntities().get(0).value());
